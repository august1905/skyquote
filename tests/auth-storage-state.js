...
// (see global-setup.js) instead of every test paying for its own login —
// those are real Data Store calls against Catalyst's (billed) free tier, and
// almost no test actually needs a distinct identity. Tests that DO need
// their own login (the auth flow itself, or a genuinely separate identity)
...
// routes/users.js and src/pages/AdminUsers.jsx), so global-setup.js logs in
